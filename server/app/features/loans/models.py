...
from sqlalchemy import String, Enum as SQLAEnum, ForeignKey, DateTime
...
class UserLoanApplication(Base):
    ...
    loanId:Mapped[int]=mapped_column(ForeignKey("bank_loan.id",ondelete="CASCADE"),primary_key=True)
